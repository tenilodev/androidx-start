...
fun generateUID () : String {
    ...
    val string = android.util.Base64.encode(data, Base64.NO_WRAP)
    return String(string)
}


fun setOnQueryTextListener(queryTextSubmit : (String) -> Unit, queryTextChange : (String) -> Unit) : SearchView.OnQueryTextListener {
    return setOnQueryTextListener(queryTextSubmit, queryTextChange)
}
